      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h1 className="m-0 text-dark">Evaluator Dashboard</h1>
          </div>{/* /.col */}
          <div className="col-sm-6">
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-info">
              ...
              <Link to="/coming-soon" className="small-box-footer">More info <i className="fas fa-arrow-circle-right" /></Link>
            </div>
          </div>
          {/* ./col */}
          <div className="col-lg-3 col-6">
          ...
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-warning">
              <div className="inner">
                <h3>44</h3>
                <p>Evaluations completed/pending</p>
              </div>
              <div className="icon">
                ...
                <div className="card-tools">
                  <ul className="nav nav-pills ml-auto">
                    <li className="nav-item">
                      <Link className="nav-link active" to="/coming-soon" data-toggle="tab">Pie Chart</Link>
                    </li>
                    <li className="nav-item">
                      <Link className="nav-link" to="/coming-soon" data-toggle="tab">Bar Graph</Link>
                    </li>
                  </ul>
                </div>
              </div>{/* /.card-header */}
              ...
              <div className="card-header">
                ...
                <div className="card-tools">
                  <ul className="pagination pagination-sm">
                    <li className="page-item"><Link  to="/coming-soon" className="page-link">«</Link></li>
                    <li className="page-item"><Link to="/coming-soon" className="page-link">1</Link></li>
                    <li className="page-item"><Link  to="/coming-soon" className="page-link">2</Link></li>
                    <li className="page-item"><Link to="/coming-soon" className="page-link">3</Link></li>
                    <li className="page-item"><Link  to="/coming-soon" className="page-link">»</Link></li>
                  </ul>
                </div>
              </div>
                ...
                <div className="card-tools">
                  ...
                  <div className="btn-group">
                    ...
                    <div className="dropdown-menu float-right" role="menu">
                      <Link to="/coming-soon" className="dropdown-item">Add new event</Link>
                      <Link to="/coming-soon" className="dropdown-item">Clear events</Link>
                      <div className="dropdown-divider" />
                      <Link to="/coming-soon" className="dropdown-item">View calendar</Link>
                    </div>
                  </div>
